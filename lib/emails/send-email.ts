...
type EmailType = 'welcome' | 'approval' | 'rejection' | 'booking_confirmation' | 'booking_status' | 'password_reset' | 'feedback_request' | 'certificate_ready' | 'webinar_speaker_invite' | 'webinar_live' | 'webinar_recording'
