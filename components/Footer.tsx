        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-navy-foreground/70">
              ...
              <li><Link href="/events" className="hover:text-navy-foreground transition-colors">Annual Weekend</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-navy-foreground/70">
              ...
              <li><Link href="/register" className="hover:text-navy-foreground transition-colors">Join</Link></li>
              <li><Link href="/login" className="hover:text-navy-foreground transition-colors">Log In</Link></li>
            </ul>
          </div>
