...
Manage hospitals and medical institutions from the Institutions page. Institutions are referenced by [Fellowships](education.md#fellowships) (for location) and [Events](events.md) (for venue).
...
Manage sponsors and partners from the Sponsors page.
...
2. Fill in:
   ...
   * **Logo** — Upload the sponsor's logo (max 2 MB). A preview is shown after upload.
