...
The dashboard gives you a snapshot of your site content:
...
| Events       | Create and manage events, applications, feedback   |
...
Across the panel you can upload images (event banners, faculty photos, sponsor logos, etc.):
